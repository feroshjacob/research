 ...
 * undo object.
 */
public class O_RefactoringExecutionHelper {
	...
	private class Operation implements IWorkspaceRunnable {
		...
		public void run(IProgressMonitor pm) throws CoreException {
			try {
				...
				pm.done();
				IFile file2 = FileBuffers.getWorkspaceFileAtLocation(new Path(ConstantStore.getNewFilepath()));
				if(file2 ==null) return ;
					
			 try {


				 CSeRDBController.initcopy(ConstantStore.getFile(), file2);	 
	 ...
	 * @param context
	 */
	public O_RefactoringExecutionHelper(Refactoring refactoring, int stopSeverity, int saveMode, Shell parent, IRunnableContext context) {
		super();
